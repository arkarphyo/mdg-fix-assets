...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  // OptionItem selectedSheet = OptionItem(title: "Choose Sheet", id: "default");
  // OptionItem selectedDepartment =
  //     OptionItem(title: "Choose Department", id: "derault");
              ...
              children: [
                CustomDropdownSearch(
                  ...
                  onChange: (selectedItem) {
                    ...
                    getCellValues(selectedItem!);

                    getHeaderValues(selectedItem!).then((headers) {
                      setState(() {
                        print(
                            "SHEET : ${selectedItem}, FILTER : ${headers[3]}, Department Count : ${departmentList.length}");
                      });
                    });
                  },
                ),
...
class TableView extends StatelessWidget {
  ...
  final List<DataColumn2> headerList;
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        cellsList.length > 0
            ? Text("${cellsList[1][headerValues[0]]}")
            : Text("-"),
        Flexible(
          child: cellsList.length > 0 && headerList.length > 0
              ? DataTable2(
                  columnSpacing: 12,
                  horizontalMargin: 12,
                  minWidth: 600,
                ...
                ) //Text("${cellsList[0][headerValues[0]]}")
              : Container(
                  height: 1,
                  width: MediaQuery.of(context).size.width / 4,
                  child: LinearProgressIndicator()),
